...
Como F, I e S são independentes, podemos expandir a soma sobre todos os estados possíveis. O cálculo detalhado envolve somar 12 termos (2 estados de F × 3 estados de I × 2 estados de S).
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{parte1_1.jpeg}
\caption{Questões 1,2 e 3 -- Parte 1}
\label{fig:parte1_1}
\end{figure}
...
Neste caso, a dependência de C com relação a I e S (além de F) resulta em diferentes probabilidades condicionais para cada combinação de estados. O cálculo completo mostra que:
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{parte1_2.jpeg}
\caption{Questões 4,5,6 -- Parte 1}
\label{fig:parte1_2}
\end{figure}
...
&\quad 0,5 \times 0,1 \times 0,5 \times 0,3 + 0,5 \times 0,8 \times 0,5 \times 0,7 + \nonumber \\
&\quad\quad 0,5 \times 0,9 \times 0,5 \times 0,3 + 0,5 \times 0,5 \times 0,5 \times 0,7 \nonumber \\
&= 0,0075 + 0,14 + 0,0675 + 0,0875 \nonumber \\
&= 0,3025
\end{align}

(Note: O fator 0,5 = $P(V=\text{Sim} \mid N=\text{Sec})$ é comum a todos os termos)

Cálculos similares para os outros níveis:
\begin{itemize}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{parte2_1.jpeg}
\caption{Questão 2 -- Passo 1 -- Parte 2}
\label{fig:parte2_1}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{parte2_2.jpeg}
\caption{Questão 2 -- Passo 2,3,4 -- Parte 2}
\label{fig:parte2_2}
\end{figure}
