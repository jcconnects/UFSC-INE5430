...
\begin{itemize}
  \item \textbf{Com sementes} — 
  \item \textbf{Fermentação Natural} — 
  \item \textbf{Com castanhas e Frutas secas} — 
\end{itemize}

\subsection{Queijos semicurados}
Descrição: Queijos feitos com leite de vaca, sem adição de conservantes.
\begin{itemize}
  \item \textbf{Parmesão Jovem} — 
  \item \textbf{Gouda} — 
  \item \textbf{Canastra Meia Cura} — 
\end{itemize}

\subsection{Bolos Citricos}
Descrição: Bolos feitos com farinha de trigo, sem adição de fermento químico.
\begin{itemize}
  \item \textbf{Laranja com calda} — 
  \item \textbf{Limão} — 
  \item \textbf{Tangerina com cobertura leve} — 
\end{itemize}
